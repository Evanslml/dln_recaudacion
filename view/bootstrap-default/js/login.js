function goLogin() {
  ...
  connect.onreadystatechange = function() {
    if(connect.readyState == 4 && connect.status == 200) {
      ...
      result += '<strong> espere porfavor....   </strong> <img src="http://app1.dirislimanorte.gob.pe/recaudacion/view/bootstrap-default/img/ajax-loader.gif"> </span>';
      result += '</div>';
      __('_AJAX_LOGIN_').innerHTML = result;
    }
  }
  connect.open('POST','http://app1.dirislimanorte.gob.pe/recaudacion/ajax.php?mode=login',true);
