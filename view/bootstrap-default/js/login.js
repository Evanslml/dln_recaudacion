function goLogin() {
  ...
  connect.onreadystatechange = function() {
    if(connect.readyState == 4 && connect.status == 200) {
      ...
      result += '<strong> espere porfavor....   </strong> <img src="http://192.168.0.150:8080/dln_recaudacion/view/bootstrap-default/img/ajax-loader.gif"> </span>';
      result += '</div>';
      __('_AJAX_LOGIN_').innerHTML = result;
    }
  }
  connect.open('POST','http://192.168.0.150:8080/dln_recaudacion/ajax.php?mode=login',true);
