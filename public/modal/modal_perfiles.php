						...
						<?php foreach ($_ListaObjetos as $key => $value) {
				            if($value[5]=='0'){
				              echo "<li style=\"display: block;\">";
				                  echo "<label class=\"container_checkbox\"> ".$value[2]."<input type=\"checkbox\" id=\"MyCheck".$key."\"><span class=\"checkmark\"></span></label>";
				                  $id=$value[0]; //MOBJ_ID
				                  ...
				                  foreach ($_ListaObjetos as $key1 => $value1) {
				                     if($value1[5]==$id){//SI OBJ_PADRE ES IGUAL AL ID
				                      echo "<li>";
				                      echo "<label class=\"container_checkbox\"> ".$value1[2]."<input type=\"checkbox\" id=\"MyCheck".$key1."\"><span class=\"checkmark\"></span>";
				                      echo "</li>";
				                      }
				                  }
				                  echo "</ul>";
