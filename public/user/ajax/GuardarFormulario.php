...
/*        	var_dump($monto);*/
        	...
        	$z = array('0' => $id1, '1' => $ide, '2' => $ida, '3' => $idm, '4' => $f, '5' => $fo, '6' => $t1, '7' => $c, '8' => $d, '9' => $cantsismed, '10' => $impsismed, '11' => $h, '12' => 0, '13' => $id_usuario);
            $y = array('0' => $id2, '1' => $ide, '2' => $ida, '3' => $idm, '4' => $f, '5' => $fo, '6' => $t2, '7' => $a, '8' => $b, '9' => $cantrdr, '10' => $imprdr, '11' => $h, '12' => 0, '13' => $id_usuario);
/*
            var_dump($z);
            var_dump($y);
*/            

			$NuevoFormulario01 = new Recaudacion($z[0],$z[1],$z[2],$z[3],$z[4],$z[5],$z[6],$z[7],$z[8],$z[9],$z[10],$z[11],$z[12],$z[13]);
        	$NuevoFormulario02 = new Recaudacion($y[0],$y[1],$y[2],$y[3],$y[4],$y[5],$y[6],$y[7],$y[8],$y[9],$y[10],$y[11],$y[12],$y[13]);
